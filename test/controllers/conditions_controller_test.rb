...
class ConditionsControllerTest < ActionController::TestCase
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post :create, condition: { bronze: @condition.bronze, gold: @condition.gold, name: @condition.name, silver: @condition.silver }
    end
  ...
  test "should update condition" do
    patch :update, id: @condition, condition: { bronze: @condition.bronze, gold: @condition.gold, name: @condition.name, silver: @condition.silver }
    assert_redirected_to condition_path(assigns(:condition))
  end
